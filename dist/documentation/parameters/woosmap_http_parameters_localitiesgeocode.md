...
-   <h3 class="parameter-name" id="types">types</h3>
    ...
    The types of geocoding response to return. This parameter will be ignored when used with the `latlng` parameter. When running a geocode request with the `address` parameter, it can be used to select the expected type of result.
